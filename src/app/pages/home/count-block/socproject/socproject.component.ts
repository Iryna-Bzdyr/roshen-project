...
@Component({
  selector: 'app-socproject',
  templateUrl: './socproject.component.html',
  styleUrls: ['./socproject.component.scss']
})
export class SocprojectComponent implements OnInit {
  ...
  registerEventListeners() {
		var elements = document.querySelectorAll('.purecounter4');
